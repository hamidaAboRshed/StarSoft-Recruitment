    ...
    <nav class="navbar navbar-default main-navbar" role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->
           <a class="navbar-brand logo" href="index.html"><img src="<?php echo base_url();?>assets/images/logo.jpg" alt="logo"></a>                      
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav main-nav menu-scroll">
            <li><a href="index.html">Home</a></li>             
            <li class="active"><a href="blog-archive.html">About </a></li>
            <li class="active"><a href="blog-archive.html">Service </a></li>
                              
            <li a href="index.html"><a href="blog-archive.html">BLOG </a></li>
            <li class="active"><a href="blog-archive.html">BigFive </a></li>
            <li class="active"><a href="blog-archive.html">Contact </a></li>
          </ul>                            
        </div><!--/.nav-collapse -->
  ...
  <section id="blog-banner">
    <img src="<?php echo base_url();?>assets/images/blog-banner.jpg" alt="img">
              ...
              <div class="col-lg-8 col-md-7 col-sm-12">
                <div class="blog-left blog-archive">
                  ...
                  <article class="single-from-blog">
                    <figure>
                      <a href="blog-single.html"><img alt="img" src="<?php echo base_url();?>assets/images/the-sky.jpg"></a>
                    </figure>
                  ...
                  <article class="single-from-blog">
                    <figure>
                      <a href="blog-single.html"><img alt="img" src="<?php echo base_url();?>assets/images/andrew.jpg"></a>
                    </figure>
                    <div class="blog-title">
                      <h2><a href="blog-single.html">Here is the post title</a></h2>
                      <p>Posted by <a href="#" class="blog-admin">admin</a> on <span class="blog-date">23rd july 2015</span></p>
                      ...
                      <div class="media">
                          <div class="media-left">
                            <a href="blog-single.html">
                              <img class="media-object" src="<?php echo base_url();?>assets/images/popular-post-img.jpg" alt="img">
                            </a>
                          </div>
